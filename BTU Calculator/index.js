...
//Old Method
/*function btuH(device) {
    let deviceCurrent = csDevices[device].current[arraySelector]
    let deviceQuantity = csDevices[device].quantity.value
    let deviceIdle = csDevices[device].idleCurrent[arraySelector]
    let idleBox = csDevices[device].rmsIdleBox
    let longTermBox = csDevices[device].rmsLongTermBox
    let btuBox = csDevices[device].btuBox
    let btuMaxBox = csDevices[device].btuMax
